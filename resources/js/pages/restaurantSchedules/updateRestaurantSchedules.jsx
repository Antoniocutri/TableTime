                    ...
                    <div className="row gx-3">
                        ...
                        <div className='col-6'>
                            <InputTime
                                ...
                                name="lunch_closing_update"
                                register={register}
                                disabled={isLunchClosed}
                                errors={errors}
                                validateFn={(value) => {
                                    if(!isLunchClosed){
                                        const opening = getValues('lunch_opening_update');
                    ...
                    <div className='row gx-3'>
                        ...
                        <div className='col-6'>
                            ...
                            <InputTime
                                ...
                                name="dinner_closing_update"
                                register={register}
                                disabled={isDinnerClosed}
                                errors={errors}
                                validateFn={(value) => {
                                    if (!isDinnerClosed){
                                        const opening = getValues('dinner_opening_update');
                                        return value > opening || t("Closing must be later than opening");
                                    }
                                }}
                            />
    ...
    return (
        <>
            <h2 className="text-lg font-medium text-gray-900">
                {t('Update restaurant schedule')}
            </h2>

            <p className="mt-1 text-sm text-gray-600">
                { t('Update restaurant schedule for each day of the week') }
            </p>
        </>
    )
}
